    ...
    return (
        <main className="min-h-screen bg-(--bg) flex flex-col pb-20 pt-10 px-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 px-5 mx-auto font-bold text-(--text)">
                ...
                <a target="_blank" rel="noopener noreferrer" href="https://cal.com/delaika-co/30min">
                ...
                <a target="_blank"
                    rel="noopener noreferrer" href="https://wa.me/34607441986?text=Hola!%20Vengo%20desde%20la%20web%20de%20Delaika%20y%20me%20gustaría%20saber%20más%20sobre...">
                    <div className="bg-(--bg2) h-full p-20 w-full flex flex-col mx-auto">
                        <PhoneCall className="text-(--text) w-20 h-20 mx-auto my-auto" />
                        <h1 className="font-bold text-(--text) font-bold text-xl md:text-4xl mx-auto my-auto uppercase">WhatsApp</h1>
                    </div>
                </a>
            </div>
        </main>
