    ...
    <div  className="grid grid-cols-1 md:grid-cols-1 gap-8 rounded-xl mt-3 max-w-6xl flex flex-col mx-auto items-center px-3 md:px-0">
      ...
      <div id="esquema-section" className="bg-gradient-to-r from-(--bg2) to-black rounded-xl bg-cover md:min-h-[400px] md:p-20 flex justify-center ">
        <div className="bg-black rounded-xl flex flex-col  justify-center">
          <h1 className="text-md md:text-2xl text-white md:p-3  uppercase">Escribe un mensaje en la sección de contacto o programa una reunión.</h1>
          <br></br>
          <h1 className="text-md md:text-2xl text-white md:p-3  uppercase">Queremos entender que es lo que quieres lograr.</h1>
        </div>
      </div>
      ...
      <div id="esquema-section" className="bg-gradient-to-r from-(--bg2) to-black rounded-xl bg-cover md:min-h-[400px] md:p-20 flex justify-center ">
        <div className="bg-black rounded-xl flex flex-col  justify-center">
          <h1 className="text-md md:text-2xl text-white md:p-3 items-center uppercase">Recibirás el alcanze del proyecto junto con la propuesta económica</h1>
          <br></br>
          <h1 className="text-md md:text-2xl text-white md:p-3 items-center uppercase">Una vez el proyecto sea aprobado, empezarémos a trabajar en él.</h1>
        </div>
      </div>
      ...
      <div id="esquema-section" className="bg-gradient-to-r from-(--bg2) to-black  rounded-xl bg-cover md:min-h-[400px] md:p-10 flex  ">
        <div className="bg-black rounded-xl flex flex-col items-center justify-center">
          <h1 className="text-md md:text-2xl text-white md:p-3 items-center uppercase">QUEREMOS que estés presente en cada etapa del proyecto Y OBSERVES cómo le estamos dando vida a tu empresa digitalmente.</h1>
          <br></br>
          <h1 className="text-md md:text-2xl text-white md:p-3 items-center uppercase">Tendrémos reuniones semanales donde podrás ver avances, pedirme sugerencias, realizar cambios y en general ser parte de todo el proceso.</h1>
        </div>
      </div>
      ...
      <div id="esquema-section" className="bg-gradient-to-r from-(--bg2) to-black rounded-xl bg-cover md:min-h-[400px] md:p-20 flex justify-center ">
        <div className="bg-black rounded-xl flex flex-col items-center justify-center">
          <h1 className="uppercase text-md md:text-2xl text-white md:p-3 items-center">En la fecha pactada, te haré entrega de tu página/software con todo lo que debes saber para que puedas utilizarlo a tu favor.</h1>
          <br></br>
          <h1 className="uppercase text-md md:text-2xl text-white md:p-3 items-center">Seguiremos en contacto y yo voy a estar disponible para ti en todo momento.</h1>
        </div>
      </div>
